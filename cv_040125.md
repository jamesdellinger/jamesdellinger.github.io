...
### Commodities Trading
To supplement my income so that I could complete my decision trees library and book, I learned to trade commodities on a short-term basis. Specifically, I trade a handful of highly liquid markets (e.g. Gold and S&P 500 Index futures) a few times a week, with typical holding times of 1-2 hours. Though I will occasionally remain in a position overnight. I follow a strategy that I developed on my own—a systematic and discretionary application of George Douglass Taylor's principles. 
