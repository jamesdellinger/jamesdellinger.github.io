...
TODO:
- change job titles to h4 (####) but style just like I do h3
- change small company name to h5 (#####) but style in black just like it is now
- change date and and city text to h6 (######) but style in gray just like I do now
- test out on just one area, and leave current way in, until I verify that my styling is identical
- change [COMPANY-BREAK] to a markdown horizontal line (---) with a blank line above and below
- change [SECTION-BREAK] to something similar but slightly different. Is there a markdown symbol
  that will render as something other than a <hr> tag?
  Maybe just use a subtle divider like (=====)
- Add a h1 header for my name (# James Dellinger) at the top of the page, above the 
  ## Currently section. Use this in the top section. 

This will get rid of all html from the markdown file.
...
Peel's TV guide and remote control app was preloaded on most Samsung and HTC smart phones during the mid-2010s. At its peak it had DAUs in the millions. My journey at Peel was the experience of a lifetime.

### Product Manager
<div class="date_city_block">
<p class="date_city_text">Sep 2015–Dec 2016</p>
</div>
...
<div class="date_city_block">
<p class="date_city_text">Feb 2015–Sep 2015</p>
</div>
...
### Product Evangelist
<div class="date_city_block">
<p class="date_city_text">Aug 2014–Feb 2015</p>
</div>
...
### Consultant
<div class="date_city_block">
<p class="date_city_text">May 2014–Jul 2014</p>
</div>
