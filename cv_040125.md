...
## Languages
### Fluent Japanese
Passed the JLPT Level 1 in December 2006, which certified that I was competent to enroll university-level study in Japan.
### Conversational Korean and Chinese
Korean syntax and Chinese orthography share similarities with Japanese. This made it easy to acquire functional proficiency shortly after to relocating to each country.

## Hobbies
### Restoring Old Electronics
I painstakingly brought a vintage PC Engine system back to life during summer 2020. Here is [a chronicle](https://github.com/jamesdellinger/recent-work/blob/main/duo.ipynb) of that process.
